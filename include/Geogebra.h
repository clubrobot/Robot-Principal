...
struct Position positions_jaune[] = {
   ...
   Position(109.91151713267399f, 43.852527975099996f,0), //R2L_J_jaune
   Position(114.7951679161948f, 53.52824981187007f,0), //R3L_J_jaune
   Position(40.0f, 40.0f,PI), //R1P_J_jaune
   Position(109.91151713267399f, 39.852527975099996f,0), //R2P_J_jaune
   Position(114.7951679161948f, 57.528249811870076f,0), //R3P_J_jaune
   Position(9.88404375784381f, 55.74783708591414f,0), //R1D_J_jaune
